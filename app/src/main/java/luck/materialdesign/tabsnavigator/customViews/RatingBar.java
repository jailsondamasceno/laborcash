...
public class RatingBar extends View {
    ...
    protected static final int DEFAULT_FILLED_DRAWABLE = R.drawable.staron;
    protected static final int DEFAULT_EMPTY_DRAWABLE = R.drawable.staroff;
    ...
    protected void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            mStarSize = a.getDimensionPixelSize(R.styleable.RatingBar_starSize, getPixelValueForDP(10));
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (x >= 0 && x <= getWidth()) {
                ...
                if (x < xPerStar * .25f) {
                    ...
                    selectedAmount = (((x - xPerStar) / xPerStar) + 2);
