...
public class clientFinishedFragment  extends Fragment {
    ...
    public static clientFinishedFragment newInstance(int position) {

        Bundle args = new Bundle();
        args.putInt("page", position);
        clientFinishedFragment fragment = new clientFinishedFragment();
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if (dataSnapshot.getValue() != null){
                    ...
                    if (getArguments().getInt("page") == 2){
                        Log.d("LENGHT", String.valueOf(project.getRating().length()));
                        if (project.getStatus().equals("finished") && !project.getRating().isEmpty()){
