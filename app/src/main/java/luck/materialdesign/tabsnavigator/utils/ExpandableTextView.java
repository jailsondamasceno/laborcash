...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mContentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, 16);
        ...
        mContentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, Color.rgb(33, 150, 243));
        ...
        mStateTextColor = typedArray.getColor(R.styleable.ExpandableTextView_expandCollapseTextColor, Color.rgb(33, 150, 243));
